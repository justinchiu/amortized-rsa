...
if __name__ == '__main__':
    ...
    if args.dataset == 'single':
        ...
        # i guess, for pretraining?
        language_model_data = [f"data/shapeworld/reference-1000-{x}.npz" for x in range(60,65)]
    ...
    for epoch in range(args.epochs):
        ...
        train_metrics, _ = run(data_file, 'train', 'language_model', language_model, listener, optimizer, loss, vocab, args.batch_size, args.cuda, args.cuda)
        # Validation
        data_file = [language_model_data[-1]]
        val_metrics, _ = run(data_file, 'val', 'language_model', language_model, listener, optimizer, loss, vocab, args.batch_size, args.cuda, args.cuda)
        ...
        # Use validation loss (hoping this is NLL) to choose the best model
